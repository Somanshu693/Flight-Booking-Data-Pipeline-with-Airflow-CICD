...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="gds-airflow-projects")
    bq_project = Variable.get("bq_project", default_var="symbolic-path-463418-q4")
    ...
    file_sensor = GCSObjectExistenceSensor(
        ...
        bucket=gcs_bucket,
        object=f"flight-booking-cicd/source-{env}/flight_booking.csv",  # Full file path in GCS
    ...
    batch_details = {
        "pyspark_batch": {
            "main_python_file_uri": f"gs://{gcs_bucket}/flight-booking-cicd/spark-job/spark_transformation_job.py",  # Main Python file
